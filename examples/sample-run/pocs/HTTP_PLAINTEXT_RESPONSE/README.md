...
The selected HTTP endpoint serves a successful plaintext response
...
For a public production endpoint, consider redirecting HTTP to HTTPS; review exceptions for local labs and health checks.
